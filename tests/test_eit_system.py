import numpy as np
from pyeit.quality.eit_system import calc_signal_to_noise_ratio, calc_accuracy, calc_drift
...
def test_drift_allan():
    ...
    correct_adevs_0 = np.array([0.50144798, 0.34189729, 0.26004536, 0.21503377, 0.19580965,
                                0.17977422, 0.16560979, 0.15510351, 0.13790106, 0.12184227,
                                0.11378077, 0.1028532, 0.09888532, 0.09849245, 0.09000506,
                                0.0825436, 0.0737621, 0.06756625, 0.06567533, 0.0643697,
                                0.05971835, 0.05578692, 0.05155231, 0.04734716, 0.04230214,
                                0.03907241, 0.03439275, 0.03255361, 0.03208408, 0.0327237,
                                0.03250187, 0.03394281, 0.03573658, 0.03737299, 0.03849052,
                                0.03712749, 0.03684584, 0.03460951, 0.03283292, 0.02997242,
                                0.02945563, 0.02765693, 0.02602859, 0.02549113, 0.0244943,
                                0.02455454, 0.01994969, 0.0135816, 0.00945514])
...
def test_drift_allan_with_drift():
    ...
    correct_t2 = np.arange(1, 50)
    correct_adevs_0 = np.array([0.50151151, 0.34240022, 0.26094362, 0.21688356, 0.19928049,
                                0.18489464, 0.17249367, 0.16404771, 0.15007923, 0.13812585,
                                0.13544855, 0.13172051, 0.13419322, 0.13919843, 0.13771382,
                                0.13777519, 0.13701817, 0.13801215, 0.14205622, 0.14714887,
                                0.14925671, 0.15213755, 0.1549156, 0.15761515, 0.16228652,
                                0.1684516, 0.17457164, 0.17906281, 0.18619088, 0.19295449,
                                0.19888729, 0.20556761, 0.21200783, 0.21823937, 0.22585266,
                                0.23350849, 0.24107197, 0.249568, 0.2585531, 0.26629471,
                                0.27500569, 0.28331606, 0.29105864, 0.29524983, 0.30406007,
                                0.31541238, 0.32955649, 0.34293692, 0.34950794])
...
def test_drift_delta():
    ...
    correct_drifts = np.array([0.04459828, -0.52595789, -0.33285465, 0.0782566, -0.02511503,
                               -0.09873106, -0.27501217, -0.28731926, -0.27797152, -0.02059609])
...
def test_drift_delta_with_drift():
    ...
    correct_drifts = np.array([0.94459828, 0.37404211, 0.56714535, 0.9782566, 0.87488497,
                               0.80126894, 0.62498783, 0.61268074, 0.62202848, 0.87940391])
    drifts = calc_drift(measurements, sampling_rate=1, sample_period=10, method="Delta")
