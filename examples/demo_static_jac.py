...
mesh_new = set_perm(mesh_obj, anomaly=anomaly, background=1.)
...
""" 3. solve_eit using gaussian-newton """
...
ds = eit.gn(f1.v, lamb_decay=0.2, lamb_min=1e-4, maxiter=20, verbose=True)
